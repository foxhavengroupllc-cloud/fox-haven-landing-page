...
export const INITIATIVES: InitiativeConfig[] = [
  ...
  },
  {
    ...
    description:
      'Modular, solar-powered cooling shelters at bus stops, park nodes, and last-mile walking routes. R-16 insulated panels, radiant cooling, high-airflow fans, emergency charging — 100% off-grid.',
    details: [
    ...
    status: 'In development — Summer 2026',
    ...
    performanceStats: [
      ...
      { value: '30–40°F', label: 'MRT Drop' },
      { value: '<2 hrs', label: 'Deployment' },
